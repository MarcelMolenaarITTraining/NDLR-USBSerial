...
| [StopBits Enum](https://docs.microsoft.com/en-us/dotnet/api/system.io.ports.stopbits?view=dotnet-plat-ext-5.0) | Specifies the number of stop bits used on the SerialPort object |
