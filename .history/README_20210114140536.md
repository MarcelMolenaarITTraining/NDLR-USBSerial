...
| [StopBits Enum]() | Represents a serial port resource |


> **Note**: The System.IO.Ports.SerialPort class is also available in [.Net Core](https://www.nuget.org/packages/System.IO.Ports/) so https://docs.microsoft.com/en-us/dotnet/api/system.io.ports.stopbits?view=dotnet-plat-ext-5.0you can also try to run this script on Linux or a Mac.
