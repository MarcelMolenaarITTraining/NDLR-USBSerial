...
### Connect to the NDLR
Use 0 connect to the NDLR. If you are already connected, you can always reconnect if something wrong occurs. Any connection is close before reconnecting:
![ndlr_usbserial_connect](images/ndlr_usbserial_connect.png)
![ndlr_usbserial_connected](images/ndlr_usbserial_connected.png)
> **Note**: when you select 9 (disconnect) of x (exit) the connection will be closed. Don't use CTRL+C to end the script. The connection will remain opened.
