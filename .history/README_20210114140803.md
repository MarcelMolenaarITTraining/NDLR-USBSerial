...
| [ReadExisting](https://docs.microsoft.com/en-us/dotnet/api/system.io.ports.serialport.readexisting?view=dotnet-plat-ext-5.0#System_IO_Ports_SerialPort_ReadExisting) | Specifies the number of stop bits used on the SerialPort object |
