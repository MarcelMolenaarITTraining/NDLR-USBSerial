...
Use **a** to send the command to the NDLR and read the Presets results:
![ndlr_usbserial_read_presets_a1](images/ndlr_usbserial_read_presets_a1.png)
> **Note**: the command **\<a1\>** is send to the NDLR


### Read Patterns
Use **b** to send the command to the NDLR and read the Patterns results:
...
### d) Read Chord Seq
Use **d** to send the command to the NDLR and read the Chord Sequences:
