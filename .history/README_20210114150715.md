...
### Connect to the NDLR
Use 8 to Toggle between the available COM ports. Probably the NDLR will be connected to the highest COM port. Make sure to select the right COM port before connecting:
