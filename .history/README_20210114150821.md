...
### Connect to the NDLR
Use 0 connect to the NDLR. If you are already connected, you can always reconnect if something wrong occurs. Any T will be connected to the highest COM port. Make sure to select the right COM port before connecting:
